...
public class C04_WrapperClass {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(5);// 5
         ...
         String tc1= "123456";
         String id1="23345";
        System.out.println(tc1.concat(id1));
        System.out.println(tc1+id1);
     int yepyenı = Integer.valueOf(tc1);
        System.out.println("yepyenı:" + yepyenı);
int yenısı =Integer.valueOf(id1);
        System.out.println("yenısı:" + yenısı);
        System.out.println(yepyenı+yenısı);

        byte maxdegerı1= Byte.MAX_VALUE;
        byte mındegerı1=Byte.MIN_VALUE;
        System.out.println("maxByteDegerı:" + maxByteDegeri);
        System.out.println("minByteDegerı:" + minByteDegeri);
