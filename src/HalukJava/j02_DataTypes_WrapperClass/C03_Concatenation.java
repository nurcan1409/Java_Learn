...
public class C03_Concatenation {
    public static void main(String[] args) {
       ...
       */
        ...
        String ad1="nurcan";
        String soyad1="yerlıkaya";
        int x=20;
        int y=30;
        System.out.println(ad1+soyad1+ x);
        System.out.println(x+y+ad1+soyad1);
        System.out.println(ad1+(x+y)+(x-y));
        System.out.println(ad1+(x-y)+(x-y));

        System.out.println(" " +x+y);

      char harf='s';
        System.out.println(ad1+harf);
        System.out.println(x+harf+ad1);
        System.out.println(ad1+harf+x);
