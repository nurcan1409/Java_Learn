...
public class C03_CharAt {
    public static void main(String[] args) {
      ...
      /*  String sehir = "Istanbul";
       ...
       // System.out.println("bir kelıme gir");
       // String kelıme= sc.nextLine();
      ...
      // if (kelıme.length()%2!=0){
       ...
       // }else System.out.println("girilen kelimenin orta karakteri yoktur");
        ...
        System.out.println("bır sehır gırınız");
        String sehır= scan.nextLine();

      if (sehır.length()%2!=0) {
          System.out.println(sehır.charAt(2));
      } else System.out.println("ıl degılsın");
