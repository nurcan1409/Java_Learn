...
/*
     ...
     */
        ...
        System.out.println("64'un karekök degeri:" + Math.sqrt(64));


        System.out.println("49 karekok degerı:" + Math.sqrt(49));
        System.out.println("63 un karekoku:" + Math.sqrt(36));
        System.out.println("-40 ın mutlak degerı:" + Math.abs(-40));
        System.out.println("12,40 sayının degerı:" + Math.floor(12.40));
