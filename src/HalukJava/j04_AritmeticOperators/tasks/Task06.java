...
public class Task06 {
    ...
    public static void main(String[] args) {
      ...
      Scanner scan = new Scanner(System.in);
        ...
        System.out.println("saat gırınız");
        int saat =sc.nextInt();
        System.out.println("dakıka gırını");
        int dakıka=sc.nextInt();
        System.out.println("sanıye gırınız");
        int sanıye=sc.nextInt();
        System.out.println((saat+"saat "+dakıka+ "dakıka "+sanıye+"sanıye")+ "="+(saat*3600+dakıka*60+sanıye));
