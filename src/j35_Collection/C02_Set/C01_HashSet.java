...
/*
    ...
    public static void main(String[] args) {
        ...
        HashSet<String> hs1 = new HashSet<>(Arrays.asList("ercan", "fatıh", "alı", "nur", "rukıye"));
        ...
        System.out.println("hs1.remove(\"Asıktır\") = " + hs1.remove("Asıktır"));//varolan eleman silinirse ->trueSystem.out.println("hs1 = " + hs1);//[null, Basarı, Ercan, Adem, Kevser, Nur, Yakup, Rukiye, Gayrete ]
