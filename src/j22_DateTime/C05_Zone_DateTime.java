...
public class C05_Zone_DateTime {
    public static void main(String[] args) {


        //herhangi bir ulke-sehir->local tarih ve zaman bilgisi tutar

        LocalDate trhZone=LocalDate.now(ZoneId.of("America/New_York"));//America/NevYork local'inin anlık tarih bilgisi tanımlandıLocalDate trhZone1=LocalDate.now(ZoneId.of("Japan"));//Japan local'inin anlık tarih bilgisi tanımlandı
