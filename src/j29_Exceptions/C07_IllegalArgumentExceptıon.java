...
public class C07_IllegalArgumentExceptıon {
    public static void main(String[] args) {
        // IllegalargumentException -> kullanılmasını istenmeyen değerlerde programın hata vermesi isteniyorsa bu excp fırlatılır
        ...
        Scanner sc = new Scanner(System.in);System.out.print(" agam yasını giresen : ");
