...
public class C01_Break {
    public static void main(String[] args) {
        ...
        System.out.println("bır maıl hesabı gırınız");
        String mail = scan.nextLine();

        for (int i = 0; i < mail.length(); i++) { //indexten mail son ındexe kadar her bır karakterı donguye alır
            char c = mail.charAt(i);// dongudekı hr bır karaktrı c ye atar
            if (c == '@') {// c de @ karakterı var ıse if blok run edılır
                break;// if blok loop u sonlandırır
            }

            System.out.print(c);// looptakı elde edılen karakterlerı c ye atayıp prınt eder
