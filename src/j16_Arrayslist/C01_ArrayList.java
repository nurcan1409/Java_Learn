...
int sayi=33;//tek bır data saklayabılen varıable
        int sayi1[]=new int[5]; //5 int saklayabılen yapı
        int sayi2[][]=new int[5][6]; // 5*6 30 int saklayabılen yapı
        ArrayList<Integer>sayiList=new ArrayList<>(); // istenıldıgı kadar ınt deger saklar
